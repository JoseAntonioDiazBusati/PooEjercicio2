...
*
* Crear un constructor primario con todos los atributos, excepto nombre e imc. Este último atributo se calcula en
* función del peso y la altura. Por tanto no se debe poder modificar, pero si consultar.
*
...
*
* En el main(), crear 3 personas diferentes (la primera sin nombre)
* utilizando el constructor primario y secundario. Después mostrarlas por consola y a continuación, realizar lo siguiente:
*
* Sobre la persona 1:
